...
def test_load_across_nodes():
    ...
    for i, obj_demand_list in enumerate(obj_demands_list):
        log(DEBUG, f"i= {i}",
            ...
            load_across_nodes_when_obj_demands_replicated_to_repair_sets=service_rate_inspector.load_across_nodes_when_obj_demands_replicated_to_repair_sets(obj_demand_list),
        )
