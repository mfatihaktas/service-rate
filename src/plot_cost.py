...
def plot_cost_2d(
    ...
    cost_list = [
        service_rate_inspector.min_cost(obj_demand_list=[x, y]) for x, y in zip(x_l, y_l)
    ]
    ...
    plot.savefig(f"plot_cost_2d_{file_name_suffix}.png", bbox_inches='tight') # , bbox_extra_artists=[ax],
    fig.clear()
