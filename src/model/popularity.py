...
class PopModel_wZipf(object):
  def __init__(
      self,
      k: int,
      zipf_tailindex_rv: random_variable.RandomVariable,
      arrate_rv: random_variable.RandomVariable,
  ):
      self.k = k
    ...
    def __repr__(self):
        return (
            "PopModel_wZipf( \n"
            f"\t k= {self.k} \n"
            f"\t zipf_tailindex_rv= {self.zipf_tailindex_rv} \n"
            f"\t arrate_rv= {self.arrate_rv} \n"
            ")"
        )
    ...
    def cap_list(self, num_points: int):
      cap_list = []
      tail_index_l = [self.zipf_tailindex_rv.sample() for _ in range(num_points)]
      for tail_index in tail_index_l:
